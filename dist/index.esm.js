...
var Icon$14 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 264 270" }, props),
        React.createElement("image", { width: "264", height: "270", href: "/images/zizo/logo.png" })));
};
...
var Icon$U = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 264 270" }, props),
        React.createElement("image", { width: "264", height: "270", href: "/images/zizo/token.png" })));
};
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#e1bc5d", background: "#08060B", backgroundDisabled: "#3c3742", backgroundAlt: "#27262c", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#372F47", inputSecondary: "#262130", primaryDark: "#0098A1", tertiary: "#353547", text: "#F4EEFF", textDisabled: "#666171", textSubtle: "#B8ADD2", borderColor: "#524B63", gradients: {
...
var Logo$2 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 512 128" }, props),
        React.createElement("image", { width: "512", height: "128", href: "/images/zizo/logo-with-text.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, { alignItems: "center" },
        !hideSidebar && React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$n, { width: "24px", color: isDark ? "textSubtle" : "#997b3f" })) : (React.createElement(Icon$o, { width: "24px", color: isDark ? "textSubtle" : "#997b3f" }))),
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "#", target: "_blank" },
        ...
        React.createElement(Text, { color: isDark ? "textSubtle" : "#997b3f", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var SocialLinks = function (_a) {
    ...
    return (React.createElement(Flex, null, socials.map(function (social, index) {
        ...
        //   );
        // }
        return (React.createElement(Link, { external: true, key: social.label, href: social.href, "aria-label": social.label, mr: mr, color: "#997b3f" },
...
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            React.createElement(Logo$1, { isPushed: isPushed, hideSidebar: hideSidebar, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
            React.createElement(Flex, null,
                React.createElement(UserBlock$1, { account: account, login: login, logout: logout }))),
        React.createElement(BodyWrapper, null,
            !hideSidebar && React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, ypantyPriceUsd: ypantyPriceUsd, pushNav: setIsPushed, links: links }),
            React.createElement(Inner, { isPushed: isPushed, showMenu: showMenu, hideSidebar: hideSidebar || false }, children),
